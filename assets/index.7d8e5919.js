...
* is preserved.
* ```
*/var sa=Xe,Oh=zn,Ch=Se,Ph=dr,Th=He,Rh=wh,Fh=Sh,Qr=.6931471803691238,Yr=19082149292705877e-26,Lh=0x40000000000000,Hh=.3333333333333333,ia=1048575,Mh=2146435072,Dh=1048576,kh=1072693248;function Uh(e){var t,r,n,o,s,i,a,l,u,c,f,v;return e===0?Th:Ch(e)||e<0?NaN:(r=sa(e),s=0,r<Dh&&(s-=54,e*=Lh,r=sa(e)),r>=Mh?e+e:(s+=(r>>20)-Ph|0,r&=ia,l=r+614244&1048576|0,e=Oh(e,r|l^kh),s+=l>>20|0,a=e-1,(ia&2+r)<3?a===0?s===0?0:s*Qr+s*Yr:(i=a*a*(.5-Hh*a),s===0?a-i:s*Qr-(i-s*Yr-a)):(c=a/(2+a),v=c*c,l=r-398458|0,f=v*v,u=440401-r|0,o=f*Rh(f),n=v*Fh(f),l|=u,i=n+o,l>0?(t=.5*a*a,s===0?a-(t-c*(t+i)):s*Qr-(t-(c*(t+i)+s*Yr)-a)):s===0?a-c*(a-i):s*Qr-(c*(a-i)-s*Yr-a))))}var Bh=Uh;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var im=sm,am=Kr,lm=Se,cm=jt,um=4503599627370496;function fm(e,t,r,n){return lm(e)||am(e)?(t[n]=e,t[n+r]=0,t):e!==0&&cm(e)<im?(t[n]=e*um,t[n+r]=-52,t):(t[n]=e,t[n+r]=0,t)}var kc=fm;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* is preserved.
* ```
*/var e2=Wr,Zr=Ks,qn=Jm,Bc=[10680707,7228996,1387004,2578385,16069853,12639074,9804092,4427841,16666979,11263675,12935607,2387514,4345298,14681673,3074569,13734428,16653803,1880361,10960616,8533493,3062596,8710556,7349940,6258241,3772886,3769171,3798172,8675211,12450088,3874808,9961438,366607,15675153,9132554,7151469,3571407,2607881,12013382,4155038,6285869,7677882,13102053,15825725,473591,9065106,15363067,6271263,9264392,5636912,4652155,7056368,13614112,10155062,1944035,9527646,15080200,6658437,6231200,6832269,16767104,5075751,3212806,1398474,7579849,6349435,12618859],t2=[1.570796251296997,7549789415861596e-23,5390302529957765e-30,3282003415807913e-37,1270655753080676e-44,12293330898111133e-52,27337005381646456e-60,21674168387780482e-67],go=16777216,mo=5960464477539063e-23,Jr=qn(20),fa=qn(20),en=qn(20),Ie=qn(20);function Wc(e,t,r,n,o,s,i,a,l){var u,c,f,v,p,m,A,E,$;for(v=s,$=n[r],E=r,p=0;E>0;p++)c=mo*$|0,Ie[p]=$-go*c|0,$=n[E-1]+c,E-=1;if($=Zr($,o),$-=8*e2($*.125),A=$|0,$-=A,f=0,o>0?(p=Ie[r-1]>>24-o,A+=p,Ie[r-1]-=p<<24-o,f=Ie[r-1]>>23-o):o===0?f=Ie[r-1]>>23:$>=.5&&(f=2),f>0){for(A+=1,u=0,p=0;p<r;p++)E=Ie[p],u===0?E!==0&&(u=1,Ie[p]=16777216-E):Ie[p]=16777215-E;if(o>0)switch(o){case 1:Ie[r-1]&=8388607;break;case 2:Ie[r-1]&=4194303;break}f===2&&($=1-$,u!==0&&($-=Zr(1,o)))}if($===0){for(E=0,p=r-1;p>=s;p--)E|=Ie[p];if(E===0){for(m=1;Ie[s-m]===0;m++);for(p=r+1;p<=r+m;p++){for(l[a+p]=Bc[i+p],c=0,E=0;E<=a;E++)c+=e[E]*l[a+(p-E)];n[p]=c}return r+=m,Wc(e,t,r,n,o,s,i,a,l)}}if($===0)for(r-=1,o-=24;Ie[r]===0;)r-=1,o-=24;else $=Zr($,-o),$>=go?(c=mo*$|0,Ie[r]=$-go*c|0,r+=1,o+=24,Ie[r]=c):Ie[r]=$|0;for(c=Zr(1,o),p=r;p>=0;p--)n[p]=c*Ie[p],c*=mo;for(p=r;p>=0;p--){for(c=0,m=0;m<=v&&m<=r-p;m++)c+=t2[m]*n[p+m];en[r-p]=c}for(c=0,p=r;p>=0;p--)c+=en[p];for(f===0?t[0]=c:t[0]=-c,c=en[0]-c,p=1;p<=r;p++)c+=en[p];return f===0?t[1]=c:t[1]=-c,A&7}function r2(e,t,r,n){var o,s,i,a,l,u,c,f,v;for(s=4,a=n-1,i=(r-3)/24|0,i<0&&(i=0),u=r-24*(i+1),f=i-a,v=a+s,c=0;c<=v;c++)f<0?Jr[c]=0:Jr[c]=Bc[f],f+=1;for(c=0;c<=s;c++){for(o=0,f=0;f<=a;f++)o+=e[f]*Jr[a+(c-f)];fa[c]=o}return l=s,Wc(e,t,l,fa,u,s,i,a,Jr)}var n2=r2;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* is preserved.
* ```
*/var l2=a2,da=Xe,c2=.6366197723675814,u2=1.5707963267341256,f2=6077100506506192e-26,d2=6077100506303966e-26,v2=20222662487959506e-37,p2=20222662487111665e-37,h2=84784276603689e-45,va=2047;function g2(e,t,r){var n,o,s,i,a,l,u;return o=l2(e*c2),i=e-o*u2,a=o*f2,u=t>>20|0,r[0]=i-a,n=da(r[0]),l=u-(n>>20&va),l>16&&(s=i,a=o*d2,i=s-a,a=o*v2-(s-i-a),r[0]=i-a,n=da(r[0]),l=u-(n>>20&va),l>49&&(s=i,a=o*p2,i=s-a,a=o*h2-(s-i-a),r[0]=i-a)),r[1]=i-r[0]-a,o}var m2=g2;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* ```
*/var _2=Xe,$2=Ig,y2=Us,b2=n2,tn=m2,E2=0,I2=16777216,pt=1.5707963267341256,Ut=6077100506506192e-26,rn=2*Ut,nn=3*Ut,on=4*Ut,A2=2147483647,w2=2146435072,N2=1048575,S2=598523,O2=1072243195,C2=1073928572,P2=1074752122,T2=1074977148,R2=1075183036,F2=1075388923,L2=1075594811,H2=1094263291,_r=[0,0,0],$r=[0,0];function M2(e,t){var r,n,o,s,i,a,l,u;if(o=_2(e),s=o&A2|0,s<=O2)return t[0]=e,t[1]=0,0;if(s<=P2)return(s&N2)===S2?tn(e,s,t):s<=C2?e>0?(u=e-pt,t[0]=u-Ut,t[1]=u-t[0]-Ut,1):(u=e+pt,t[0]=u+Ut,t[1]=u-t[0]+Ut,-1):e>0?(u=e-2*pt,t[0]=u-rn,t[1]=u-t[0]-rn,2):(u=e+2*pt,t[0]=u+rn,t[1]=u-t[0]+rn,-2);if(s<=L2)return s<=R2?s===T2?tn(e,s,t):e>0?(u=e-3*pt,t[0]=u-nn,t[1]=u-t[0]-nn,3):(u=e+3*pt,t[0]=u+nn,t[1]=u-t[0]+nn,-3):s===F2?tn(e,s,t):e>0?(u=e-4*pt,t[0]=u-on,t[1]=u-t[0]-on,4):(u=e+4*pt,t[0]=u+on,t[1]=u-t[0]+on,-4);if(s<H2)return tn(e,s,t);if(s>=w2)return t[0]=NaN,t[1]=NaN,0;for(r=$2(e),n=(s>>20)-1046,u=y2(s-(n<<20|0),r),a=0;a<2;a++)_r[a]=u|0,u=(u-_r[a])*I2;for(_r[2]=u,i=3;_r[i-1]===E2;)i-=1;return l=b2(_r,$r,n,i),e<0?(t[0]=-$r[0],t[1]=-$r[1],-l):(t[0]=$r[0],t[1]=$r[1],l)}var D2=M2;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var s_=Se,i_=Kr,ga=z2,yo=Gc,a_=jt,yr=Ws,br=Gs;function l_(e){var t,r;return s_(e)?NaN:i_(e)?NaN:(r=e%2,t=a_(r),t===0||t===1?yr(0,r):t<.25?yo(br*r):t<.75?(t=.5-t,yr(ga(br*t),r)):t<1.25?(r=yr(1,r)-r,yo(br*r)):t<1.75?(t-=1.5,-yr(ga(br*t),r)):(r-=yr(2,r),yo(br*r)))}var c_=l_;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var v6=jt,Ia=Ce;function p6(e,t){return e===-1?(e-e)/(e-e):e===1?1:v6(e)<1==(t===Ia)?0:Ia}var h6=p6;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* is preserved.
* ```
*/var Ta=Se,Ra=Vc,Fa=Kr,s4=xn,La=V3,i4=jt,Ao=Bs,a4=Qn,Ha=xc,l4=He,c4=Ce,u4=a6,f4=d6,d4=h6,v4=L6,p4=G6,h4=o4,wo=2147483647,g4=1072693247,m4=1105199104,_4=1139802112,Ma=1083179008,$4=1072693248,y4=1083231232,b4=3230714880>>>0,Da=31,ht=1e300,gt=1e-300,E4=8008566259537294e-32,it=[0,0],ka=[0,0];function Xc(e,t){var r,n,o,s,i,a,l,u,c,f,v,p,m,A,E,$;if(Ta(e)||Ta(t))return NaN;if(Ao(it,t),a=it[0],l=it[1],l===0){if(t===0)return 1;if(t===1)return e;if(t===-1)return 1/e;if(t===.5)return La(e);if(t===-.5)return 1/La(e);if(t===2)return e*e;if(t===3)return e*e*e;if(t===4)return e*=e,e*e;if(Fa(t))return d4(e,t)}if(Ao(it,e),s=it[0],i=it[1],i===0){if(s===0)return u4(e,t);if(e===1)return 1;if(e===-1&&Ra(t))return-1;if(Fa(e))return e===l4?Xc(-0,-t):t<0?0:c4}if(e<0&&s4(t)===!1)return(e-e)/(e-e);if(o=i4(e),r=s&wo|0,n=a&wo|0,u=s>>>Da|0,c=a>>>Da|0,u&&Ra(t)?u=-1:u=1,n>m4){if(n>_4)return f4(e,t);if(r<g4)return c===1?u*ht*ht:u*gt*gt;if(r>$4)return c===0?u*ht*ht:u*gt*gt;m=p4(ka,o)}else m=v4(ka,o,r);if(f=a4(t,0),p=(t-f)*m[0]+t*m[1],v=f*m[0],A=p+v,Ao(it,A),E=Ha(it[0]),$=Ha(it[1]),E>=Ma){if((E-Ma|$)!==0||p+E4>A-v)return u*ht*ht}else if((E&wo)>=y4&&((E-b4|$)!==0||p<=A-v))return u*gt*gt;return A=h4(E,v,p),u*A}var I4=Xc;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ja=xn,el=Se,z$=X$,q$=jt,tl=Gr,rl=He;function ds(e,t){return el(e)||el(t)?NaN:!Ja(e)||!Ja(t)?NaN:e<0?ds(-e+t-1,t):t<0?rl:t===0?0:t===1?tl(q$(e)):e<t?rl:e-t<2?ds(e,e-t):-tl(e+1)-z$(e-t+1,t+1)}var Q$=ds;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ay=ks,eu=oy,wy=Iy;Ay(eu,"factory",wy);var Ny=eu;const tu={E:.1249,T:.0928,A:.0804,O:.0764,I:.0757,N:.0723,S:.0651,R:.0628,H:.0505,L:.0407,D:.0382,C:.0334,U:.0273,M:.0251,F:.024,P:.0214,G:.0187,W:.0168,Y:.0166,B:.0148,V:.0105,K:.0054,X:.0023,J:.0016,Q:.0012,Z:9e-4};function Sy(e,t,r=tu){const n={};let o=0;for(const s of Object.keys(r))o+=n[s]=Ny(e,t,r[s]);for(const s of Object.keys(n))n[s]/=o;return n}function Oy(e){const t=Array(26).fill(0);for(let n=0;n<e.length;++n){const o=e.charCodeAt(n);65<=o&&o<=90?++t[o-65]:97<=o&&o<=122&&++t[o-97]}const r={};for(let n=0;n<26;++n)r[String.fromCharCode(n+65)]=t[n];return r}function Cy(e,t){let r=Oy(e),n=tu;if(t&&t.length){const i=new Set(t);let a=1;if(n=Object.fromEntries(Object.entries(n).filter(([l,u])=>i.has(l)?(a-=u,!0):!1)),a<1)for(const l of Object.keys(n))n[l]/=a;r=Object.fromEntries(Object.entries(r).filter(l=>!i.has(l[0])))}const o=Object.values(r).reduce((i,a)=>i+a,0),s=Object.keys(r).reduce((i,a)=>(r[a]&&(i[a]={count:r[a],decodesToProbs:Sy(r[a],o,n)}),i),{});return{totalLetters:o,letterDetails:s}}function ru(e){return Object.entries(e).sort((t,r)=>r[1]-t[1]).map(t=>t[0])}function Py(...e){const t=Math.min(...e),r=Math.max(...e)-t;return e.map(n=>(n-t)/r)}function Ty(e,t,r){const n=(a,l)=>Math.round(a+(l-a)*r),o=n(e.r,t.r),s=n(e.g,t.g),i=n(e.b,t.b);return{r:o,g:s,b:i}}const vr=fc("encoded",()=>{const e=Re(""),t=Gt(new Map),r=he(()=>Cy(e.value)),n=(i,a)=>{for(const[l,u]of i.entries())if(u===a)return l},o=i=>i.length===1&&/[a-z]/i.test(i);return{message:e,decryptionKeys:t,allLetterStats:r,addKey:(i,a)=>{if(!o(i)||!o(a))return!1;i=i.toUpperCase(),a=a.toUpperCase();const l=n(t,a);return l&&t.delete(l),t.set(i,a),!0}}}),nu=fc("raw",()=>({message:Re("")})),Ry=e=>(kr("data-v-aa6b7497"),e=e(),Ur(),e),Fy=Ry(()=>R("p",null," Enter text below - either plain text and click encode, or a message encoded with a simple alphabetical letter for letter substitution, and click decode. This app provides some tools to help you, but it does not decode the message for you. ",-1)),Ly=rt({__name:"HomeView",setup(e){const t=vr(),r=nu(),n=Re(t.message||r.message),o=Ms(),s=()=>{r.message=n.value,t.message="",o.push({name:"encode"})},i=()=>{t.message!==n.value&&(r.message="",t.decryptionKeys.clear(),t.message=n.value),o.push({name:"decode"})};return(a,l)=>(Z(),J(ae,null,[Fy,R("fieldset",null,[R("div",null,[_n(R("textarea",{id:"message","onUpdate:modelValue":l[0]||(l[0]=u=>n.value=u)},null,512),[[C0,n.value]])]),R("button",{class:"btn",onClick:i,role:"link"},"Decode"),R("button",{class:"btn",onClick:s,role:"link"},"Encode")])],64))}});const Hy=St(Ly,[["__scopeId","data-v-aa6b7497"]]);function My(){const e=Array(26);for(let t=0;t<26;++t)e[t]=[String.fromCharCode(t+65),Math.random()];return e.sort((t,r)=>t[1]-r[1]),e.map(t=>t[0])}function ll(e,t){t||(t=My());const r=Array(e.length);for(let n=0;n<e.length;++n){const o=e.charCodeAt(n);65<=o&&o<=90?r[n]=t[o-65]:97<=o&&o<=122?r[n]=t[o-97].toLowerCase():r[n]=e[n]}return r.join("")}const Dy=["value"],ky={for:"noSpaces"},Uy={for:"noSpaces"},By={for:"noSpaces"},Wy=rt({__name:"EncodeMsg",setup(e){const t=nu().message,r=Re(ll(t)),n=Re(!1),o=Re(!1),s=Re(!1);t||Ms().push("/");const i=he(()=>{let l=r.value;return n.value&&(l=l.replace(/\s/g,"")),o.value&&(l=l.replace(/[^a-zA-Z\s]/g,"")),s.value&&(l=l.toUpperCase()),l}),a=()=>{r.value=ll(t)};return(l,u)=>(Z(),J(ae,null,[R("div",null,[R("textarea",{readonly:"",value:Ae(i)},null,8,Dy)]),R("fieldset",null,[R("label",ky,[_n(R("input",{type:"checkbox","onUpdate:modelValue":u[0]||(u[0]=c=>n.value=c),id:"noSpaces"},null,512),[[oo,n.value]]),At(" Exclude whitespace ")]),R("label",Uy,[_n(R("input",{type:"checkbox","onUpdate:modelValue":u[1]||(u[1]=c=>o.value=c),id:"noSpaces"},null,512),[[oo,o.value]]),At(" Exclude punctuation ")]),R("label",By,[_n(R("input",{type:"checkbox","onUpdate:modelValue":u[2]||(u[2]=c=>s.value=c),id:"noSpaces"},null,512),[[oo,s.value]]),At(" Capitals Only ")])]),R("button",{class:"btn",onClick:a},"New random key")],64))}});const Ky=St(Wy,[["__scopeId","data-v-a6737f22"]]),Gy=["disabled"],jy=["onClick","title"],Vy=rt({__name:"DecodingKeyboard",props:{activeEncodedLetter:null},emits:["key","enter"],setup(e){const t=e,r=vr(),n=["QWERTYUIOP".split(""),"ASDFGHJKL".split(""),[..."ZXCVBNM".split(""),"enter"]],o=Object.fromEntries(Array.from({length:26},(a,l)=>[String.fromCharCode(l+65),1/26])),s=he(()=>t.activeEncodedLetter?r.allLetterStats.letterDetails[t.activeEncodedLetter].decodesToProbs:o),i=he(()=>{const a={r:0,g:255,b:0},l={r:255,g:0,b:0},u=Py(...Object.values(s.value)),c=Object.fromEntries(Object.keys(s.value).map((v,p)=>[v,u[p]])),f=new Set(r.decryptionKeys.values());return n.map(v=>v.map(p=>{var m;return p.length===1?{value:p,colour:Ty(l,a,c[p]||0),p:`probability=${((m=s.value[p])==null?void 0:m.toFixed(3))||"[select letter]"}`,isInUse:f.has(p)}:{value:p}}))});return(a,l)=>(Z(),J("fieldset",{id:"keyboard",disabled:!e.activeEncodedLetter},[(Z(!0),J(ae,null,Je(Ae(i),(u,c)=>(Z(),J("div",{class:"row",key:c},[R("div",{class:yt(`spacer${c}`)},null,2),(Z(!0),J(ae,null,Je(u,f=>(Z(),J(ae,{key:f},[f.colour?(Z(),J("button",{key:0,type:"button",class:yt(f.isInUse?"used-key":""),style:On({borderColor:`rgb(${f.colour.r},${f.colour.g},${f.colour.b})`}),onClick:v=>a.$emit("key",f.value),title:f.p},[R("span",null,$e(f.value),1)],14,jy)):(Z(),J("button",{key:1,type:"button",class:"non-alpha",onClick:l[0]||(l[0]=v=>a.$emit("enter"))},[R("span",null,$e(f.value),1)]))],64))),128)),R("div",{class:yt(`spacer${c}`)},null,2)]))),128))],8,Gy))}});const xy=St(Vy,[["__scopeId","data-v-229a19a1"]]),Xy={id:"coded-text"},zy={key:0,class:"non-alpha char"},qy=["title","onClick"],Qy=rt({__name:"PartialDecodedText",props:{activeLetter:null},emits:["update:active-letter"],setup(e,{emit:t}){const r=e,n=vr(),o=Re(-1);Bn(()=>{window.addEventListener("keydown",a)}),Br(()=>{window.removeEventListener("keydown",a)});const s=he(()=>{let l=-1;return n.message.split(`
`).map(u=>{var f;++l;const c=Array(u.length);for(let v=0;v<u.length;++v){const p=u[v],m=p.charCodeAt(0),A=65<=m&&m<=90;if(A||97<=m&&m<=122){let E,$;A?($=p,E=n.decryptionKeys.get(p)):($=String.fromCharCode(m-32),E=(f=n.decryptionKeys.get($))==null?void 0:f.toLowerCase());const H=Boolean(E);c[v]={id:l++,uc:$,display:E||p,prior:H?`decrypted from '${p}''`:void 0,isDecrypted:H,isNonAlpha:!1}}else c[v]={id:l++,display:p,isNonAlpha:!0}}return c})});function i(l){o.value=l,t("update:active-letter",l===-1?"":n.message[l].toUpperCase())}Wt(()=>r.activeLetter,l=>{o.value!==-1&&l!==n.message[o.value].toUpperCase()&&(o.value=-1)});function a(l){if(o.value===-1||l.key!=="ArrowRight"&&l.key!=="ArrowLeft")return;const u=c(n.message,o.value,l.key==="ArrowRight");u>=0&&i(u);function c(f,v,p=!0){let m=v,A=p?()=>++m<f.length:()=>--m>=0,E;for(;A()&&((E=f.charCodeAt(m))<65||90<E&&E<97||122<E););return m<f.length?m:-1}}return(l,u)=>(Z(),J("div",Xy,[(Z(!0),J(ae,null,Je(Ae(s),(c,f)=>(Z(),J("div",{key:f},[(Z(!0),J(ae,null,Je(c,v=>(Z(),J(ae,{key:v.id},[v.isNonAlpha?(Z(),J("span",zy,$e(v.display),1)):(Z(),J("span",{key:1,class:yt(["alpha char",{current:v.id===o.value,"active-letter":v.uc===e.activeLetter,decrypted:v.isDecrypted}]),title:v.prior,onClick:p=>i(v.id)},$e(v.display),11,qy))],64))),128))]))),128))]))}});const Yy=St(Qy,[["__scopeId","data-v-ce829751"]]),xs=e=>(kr("data-v-2309fe36"),e=e(),Ur(),e),Zy=xs(()=>R("td",null,null,-1)),Jy=["onClick"],e5=xs(()=>R("th",null,"count",-1)),t5=xs(()=>R("th",null,"decoded",-1)),r5=rt({__name:"DecodingKeyStats",props:{activeLetter:null},setup(e){const t=e,r=vr(),n=Re(),o=he(()=>Object.keys(r.allLetterStats.letterDetails)),s=he(()=>o.value.map((l,u)=>({display:r.decryptionKeys.get(l)||"",id:r.decryptionKeys.get(l)||u}))),i=he(()=>Object.values(r.allLetterStats.letterDetails).map(l=>ru(l.decodesToProbs).map(u=>({letter:u,prob:l.decodesToProbs[u].toFixed(3)})))),a=l=>{switch(Math.round(l%10)){case 1:return"st";case 2:return"nd";case 3:return"rd";default:return"th"}};return Wt(()=>t.activeLetter,l=>{if(l&&n.value&&n.value.scrollWidth>n.value.clientWidth){const u=n.value.scrollWidth/(o.value.length+1);let f=(o.value.indexOf(l)+1.5)*u-.5*n.value.clientWidth;f<0&&(f=0),n.value.scrollLeft=f}}),(l,u)=>(Z(),J("div",{id:"letter-details",ref_key:"mainDiv",ref:n},[R("table",null,[R("tbody",null,[R("tr",null,[Zy,(Z(!0),J(ae,null,Je(Ae(o),c=>(Z(),J("th",{key:c},[R("a",{href:"#",class:yt(e.activeLetter===c?"active":""),onClick:F0(f=>l.$emit("update:active-letter",c),["prevent"])},$e(c),11,Jy)]))),128))]),R("tr",null,[e5,(Z(!0),J(ae,null,Je(Ae(r).allLetterStats.letterDetails,(c,f)=>(Z(),J("td",{key:f},$e(c.count),1))),128))]),R("tr",null,[t5,(Z(!0),J(ae,null,Je(Ae(s),c=>(Z(),J("td",{key:c.id},$e(c.display),1))),128))]),(Z(),J(ae,null,Je(3,c=>R("tr",{key:c},[R("th",null,[At($e(c),1),R("sup",null,$e(a(c)),1)]),(Z(!0),J(ae,null,Je(Ae(i),(f,v)=>(Z(),J("td",{key:v},$e(f[c-1].letter)+"\xA0("+$e(f[c-1].prob)+") ",1))),128))])),64))])])],512))}});const n5=St(r5,[["__scopeId","data-v-2309fe36"]]),o5=e=>(kr("data-v-3efff174"),e=e(),Ur(),e),s5={key:0,class:"message"},i5=o5(()=>R("hr",null,null,-1)),a5=rt({__name:"DecodeMsg",setup(e){const t=Re(""),r=Re(""),n=vr(),o=Ms();n.message||o.push({name:"home"}),Bn(()=>{window.addEventListener("keyup",s),a("click on letter within the message to select the encoded letter, then use the keyboard to determine what the real letter is")}),Br(()=>{window.removeEventListener("keyup",s)});function s(l){i(l.key)}function i(l){n.addKey(t.value,l)}function a(l,u=3e3){r.value=l,u>0&&setTimeout(()=>{r.value=""},u)}return(l,u)=>(Z(),J(ae,null,[ye(Ls,null,{default:Ss(()=>[r.value?(Z(),J("div",s5,$e(r.value),1)):qf("",!0)]),_:1}),ye(Yy,{"active-letter":t.value,"onUpdate:active-letter":u[0]||(u[0]=c=>t.value=c)},null,8,["active-letter"]),i5,R("div",null,[R("h4",null,[At(" Total letters: "),R("output",null,$e(Ae(n).allLetterStats.totalLetters),1)])]),ye(xy,{onKey:i,onEnter:u[1]||(u[1]=c=>Ae(o).push({name:"decoded-key-details"})),"active-encoded-letter":t.value},null,8,["active-encoded-letter"]),ye(n5,{"active-letter":t.value,"onUpdate:active-letter":u[2]||(u[2]=c=>t.value=c)},null,8,["active-letter"])],64))}});const l5=St(a5,[["__scopeId","data-v-3efff174"]]),ou=e=>(kr("data-v-4a52d52e"),e=e(),Ur(),e),c5={id:"letter-details"},u5=ou(()=>R("tr",null,[R("th",{rowspan:"2"},"Encoded"),R("th",{rowspan:"2"},"Decodes to"),R("th",{rowspan:"2"},"Occurences"),R("th",{colspan:"3"},"probabilities")],-1)),f5=ou(()=>R("tr",null,[R("th",null,"Value"),R("th",null,"Rank / 26"),R("th",null,"max (all letters)")],-1)),d5=["onClick"],v5=rt({__name:"DecodedKeysFinalDetails",setup(e){const t=vr(),r=he(()=>[...t.decryptionKeys.keys()].map(n=>{const o=t.decryptionKeys.get(n),s=t.allLetterStats.letterDetails[n],i=ru(s.decodesToProbs),a=l=>l.toFixed(4);return{encoded:n,decoded:o,count:s.count,pValue:a(s.decodesToProbs[o]),rank:i.indexOf(o)+1,maxP:s.decodesToProbs[i[0]].toFixed(3),maxLetter:i[0]}}));return(n,o)=>{const s=wf("RouterLink");return Z(),J(ae,null,[R("div",c5,[R("table",null,[R("tbody",null,[u5,f5,(Z(!0),J(ae,null,Je(Ae(r),i=>(Z(),J("tr",{key:i.encoded},[R("td",null,$e(i.encoded),1),R("td",null,$e(i.decoded),1),R("td",null,$e(i.count),1),R("td",null,$e(i.pValue),1),R("td",null,$e(i.rank),1),R("td",null,$e(i.maxP)+"\xA0("+$e(i.maxLetter)+")",1)]))),128))])])]),ye(s,{to:"/decode",custom:""},{default:Ss(({navigate:i})=>[R("button",{class:"btn",onClick:i,role:"link"},"Back to decoding",8,d5)]),_:1})],64)}}});const p5=St(v5,[["__scopeId","data-v-4a52d52e"]]),h5=Vd({history:ld("/letter-swap-decoder/"),routes:[{path:"/",name:"home",component:Hy},{path:"/decode",name:"decode",component:l5},{path:"/encode",name:"encode",component:Ky},{path:"/decoded-key-details",name:"decoded-key-details",component:p5}]});const Xs=M0(Yd);Xs.use(U0());Xs.use(h5);Xs.mount("#app");
