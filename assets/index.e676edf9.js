...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var kv=Pe,Dv=He;function Uv(e){return e===kv||e===Dv}var Wv=Uv;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var kp=Rp,Dp=Lp,Up=Mp,Zo;kp()?Zo=Dp:Zo=Up;var cr=Zo;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var k1=typeof Uint16Array=="function"?Uint16Array:null,D1=k1;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var U1=L1,fo=M1,na=D1;function W1(){var e,t;if(typeof na!="function")return!1;try{t=[1,3.14,-3.14,fo+1,fo+2],t=new na(t),e=U1(t)&&t[0]===1&&t[1]===3&&t[2]===fo-2&&t[3]===0&&t[4]===1}catch{e=!1}return e}var B1=W1;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* is preserved.
* ```
*/var sa=qe,Oh=zn,Ch=Oe,Ph=dr,Th=He,Rh=wh,Fh=Sh,Qr=.6931471803691238,Yr=19082149292705877e-26,Lh=0x40000000000000,Hh=.3333333333333333,ia=1048575,Mh=2146435072,kh=1048576,Dh=1072693248;function Uh(e){var t,r,n,o,s,i,a,l,u,c,f,v;return e===0?Th:Ch(e)||e<0?NaN:(r=sa(e),s=0,r<kh&&(s-=54,e*=Lh,r=sa(e)),r>=Mh?e+e:(s+=(r>>20)-Ph|0,r&=ia,l=r+614244&1048576|0,e=Oh(e,r|l^Dh),s+=l>>20|0,a=e-1,(ia&2+r)<3?a===0?s===0?0:s*Qr+s*Yr:(i=a*a*(.5-Hh*a),s===0?a-i:s*Qr-(i-s*Yr-a)):(c=a/(2+a),v=c*c,l=r-398458|0,f=v*v,u=440401-r|0,o=f*Rh(f),n=v*Fh(f),l|=u,i=n+o,l>0?(t=.5*a*a,s===0?a-(t-c*(t+i)):s*Qr-(t-(c*(t+i)+s*Yr)-a)):s===0?a-c*(a-i):s*Qr-(c*(a-i)-s*Yr-a))))}var Wh=Uh;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var gg=cr,mg=ur,_g=hg,Rc=new mg(1),$g=new gg(Rc.buffer);function yg(e){return Rc[0]=e,$g[_g]}var bg=yg;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ag=fr,Fc,is,as;Ag===!0?(is=1,as=0):(is=0,as=1);Fc={HIGH:is,LOW:as};var wg=Fc;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ng=cr,Sg=ur,Lc=wg,Hc=new Sg(1),la=new Ng(Hc.buffer),Og=Lc.HIGH,Cg=Lc.LOW;function Pg(e,t){return la[Og]=e,la[Cg]=t,Hc[0]}var Tg=Pg;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Ug=fr,Mc,ls,cs;Ug===!0?(ls=1,cs=0):(ls=0,cs=1);Mc={HIGH:ls,LOW:cs};var Wg=Mc;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Bg=cr,Kg=ur,kc=Wg,Dc=new Kg(1),ca=new Bg(Dc.buffer),Gg=kc.HIGH,jg=kc.LOW;function xg(e,t){return Dc[0]=t,e[0]=ca[Gg],e[1]=ca[jg],e}var Vg=xg;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ua=Vg;function Xg(e,t){return arguments.length===1?ua([0,0],e):ua(e,t)}var zg=Xg;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var Qg=Ws,Yg=qe,Zg=Us,Jg=2147483648>>>0,e2=2147483647,vo=[0,0];function t2(e,t){var r,n;return Qg(vo,e),r=vo[0],r&=e2,n=Yg(t),n&=Jg,r|=n,Zg(r,vo[1])}var r2=t2;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var o2=22250738585072014e-324,s2=o2;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var i2=s2,a2=Kr,l2=Oe,c2=jt,u2=4503599627370496;function f2(e,t,r,n){return l2(e)||a2(e)?(t[n]=e,t[n+r]=0,t):e!==0&&c2(e)<i2?(t[n]=e*u2,t[n+r]=-52,t):(t[n]=e,t[n+r]=0,t)}var Uc=f2;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var d2=Uc;function v2(e){return d2(e,[0,0],1,0)}var p2=v2;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var h2=Ds,Wc=p2,g2=Uc;h2(Wc,"assign",g2);var m2=Wc;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var y2=qe,b2=$2,E2=dr;function I2(e){var t=y2(e);return t=(t&b2)>>>20,t-E2|0}var A2=I2;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var S2=Pe,O2=He,C2=dr,P2=Lg,T2=Mg,R2=Dg,F2=Oe,L2=Kr,H2=Bs,M2=m2.assign,k2=N2,D2=Ws,U2=Us,W2=2220446049250313e-31,B2=2148532223>>>0,po=[0,0],ho=[0,0];function K2(e,t){var r,n;return t===0||e===0||F2(e)||L2(e)?e:(M2(e,po,1,0),e=po[0],t+=po[1],t+=k2(e),t<R2?H2(0,e):t>P2?e<0?O2:S2:(t<=T2?(t+=52,n=W2):n=1,D2(ho,e),r=ho[0],r&=B2,r|=t+C2<<20,n*U2(r,ho[1])))}var G2=K2;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/function x2(e,t){var r,n;for(r=[],n=0;n<t;n++)r.push(e);return r}var V2=x2;/**
* @license Apache-2.0
*
* Copyright (c) 2021 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var q2=z2;function Q2(e){return q2(0,e)}var Y2=Q2;/**
* @license Apache-2.0
*
* Copyright (c) 2021 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var ba=D3;function U3(e){return e>0?ba(e-1):ba(e+1)}var W3=U3;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* is preserved.
* ```
*/var k6=Qn,D6=M6,U6=1.4426950408889634,W6=1.4426950216293335,B6=19259629911266175e-24;function K6(e,t){var r,n,o,s,i,a;return o=t-1,s=o*o*D6(o),i=W6*o,a=o*B6-s*U6,n=i+a,n=k6(n,0),r=a-(n-i),e[0]=n,e[1]=r,e}var G6=K6;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* is preserved.
* ```
*/var T4=Oe,Ua=Cc,R4=He,Wa=Pe,F4=P4,L4=.6931471803691238,H4=19082149292705877e-26,Ba=1.4426950408889634,M4=709.782712893384,k4=-745.1332191019411,Qc=1/(1<<28),D4=-Qc;function U4(e){var t,r,n;return T4(e)||e===Wa?e:e===R4?0:e>M4?Wa:e<k4?0:e>D4&&e<Qc?1+e:(e<0?n=Ua(Ba*e-.5):n=Ua(Ba*e+.5),t=e-n*L4,r=n*H4,F4(t,r,n))}var W4=U4;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
*
* The original code was developed by W. Fullerton of Los Alamos Scientific Laboratory, a governmental institution, and is therefore public domain.
*/var F$=qc,L$=R$,H$=9490626562425156e-8,M$=3745194030963158e291;function k$(e){return e<10?NaN:e>=M$?0:e<H$?L$(2*F$(10/e,2)-1)/e:1/(e*12)}var D$=k$;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
*
* The original code was developed by W. Fullerton of Los Alamos Scientific Laboratory, a governmental institution, and is therefore public domain.
*/var U$=d3,Ya=js,Oo=d$,W$=E$,B$=S$,vn=Gr,K$=C$,G$=He,Za=Pe,Ir=D$;function j$(e,t){var r,n,o;return n=B$(e,t),o=W$(e,t),n<0?NaN:n===0?Za:o===Za?G$:n>=10?(r=Ir(n)+Ir(o)-Ir(n+o),-.5*vn(o)+K$+r+(n-.5)*vn(n/(n+o))+o*Ya(-n/(n+o))):o>=10?(r=Ir(o)-Ir(n+o),U$(n)+r+n-n*vn(n+o)+(o-.5)*Ya(-n/(n+o))):vn(Oo(n)*(Oo(o)/Oo(n+o)))}var x$=j$;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
...
* See the License for the specific language governing permissions and
* limitations under the License.
*/var vy=Ds,eu=cy,py=dy;vy(eu,"factory",py);var hy=eu;/**
* @license Apache-2.0
*
* Copyright (c) 2018 The Stdlib Authors.
*
