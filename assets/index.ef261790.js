...
`).map(s=>{var a;const i=Array(s.length);for(let l=0;l<s.length;++l){const c=s[l],u=c.charCodeAt(0),f=65<=u&&u<=90;if(f||97<=u&&u<=122){let v,h;f?(h=c,v=r.decryptionKeys.get(c)):(h=String.fromCharCode(u-32),v=(a=r.decryptionKeys.get(h))==null?void 0:a.toLowerCase());const _=Boolean(v);i[l]={id:l,uc:h,display:v||c,prior:_?`decrypted from '${c}''`:void 0,isDecrypted:_,isNonAlpha:!1}}else i[l]={id:l,display:c,isNonAlpha:!0}}return i}));function o(s){t("update:active-letter",s)}return(s,i)=>(Z(),J("div",Xy,[(Z(!0),J(ae,null,Je(Ae(n),(a,l)=>(Z(),J("div",{key:l},[(Z(!0),J(ae,null,Je(a,c=>(Z(),J(ae,{key:c.id},[c.isNonAlpha?(Z(),J("span",zy,$e(c.display),1)):(Z(),J("span",{key:1,class:yt(["alpha char",{current:c.uc===e.activeLetter,decrypted:c.isDecrypted}]),title:c.prior,onClick:u=>o(c.uc)},$e(c.display),11,qy))],64))),128))]))),128))]))}});const Yy=St(Qy,[["__scopeId","data-v-09294748"]]),xs=e=>(kr("data-v-86a55dd9"),e=e(),Ur(),e),Zy={id:"letter-details"},Jy=xs(()=>R("td",null,null,-1)),eb=["onClick"],tb=xs(()=>R("th",null,"count",-1)),rb=xs(()=>R("th",null,"decoded",-1)),nb=rt({__name:"DecodingKeyStats",props:{activeLetter:null},setup(e){const t=dr(),r=he(()=>Object.keys(t.allLetterStats.letterDetails)),n=he(()=>r.value.map(i=>t.decryptionKeys.get(i)||"")),o=he(()=>Object.values(t.allLetterStats.letterDetails).map(i=>ru(i.decodesToProbs).map(a=>({letter:a,prob:i.decodesToProbs[a].toFixed(3)})))),s=i=>{switch(Math.round(i%10)){case 1:return"st";case 2:return"nd";case 3:return"rd";default:return"th"}};return(i,a)=>(Z(),J("div",Zy,[R("table",null,[R("tbody",null,[R("tr",null,[Jy,(Z(!0),J(ae,null,Je(Ae(r),l=>(Z(),J("th",{key:l},[R("a",{href:"#",class:yt(e.activeLetter===l?"active":""),onClick:F0(c=>i.$emit("update:active-letter",l),["prevent"])},$e(l),11,eb)]))),128))]),R("tr",null,[tb,(Z(!0),J(ae,null,Je(Ae(t).allLetterStats.letterDetails,(l,c)=>(Z(),J("td",{key:c},$e(l.count),1))),128))]),R("tr",null,[rb,(Z(!0),J(ae,null,Je(Ae(n),l=>(Z(),J("td",{key:l},$e(l),1))),128))]),(Z(),J(ae,null,Je(3,l=>R("tr",{key:l},[R("th",null,[At($e(l),1),R("sup",null,$e(s(l)),1)]),(Z(!0),J(ae,null,Je(Ae(o),(c,u)=>(Z(),J("td",{key:u},$e(c[l-1].letter)+"\xA0("+$e(c[l-1].prob)+") ",1))),128))])),64))])])]))}});const ob=St(nb,[["__scopeId","data-v-86a55dd9"]]),sb=e=>(kr("data-v-3efff174"),e=e(),Ur(),e),ib={key:0,class:"message"},ab=sb(()=>R("hr",null,null,-1)),lb=rt({__name:"DecodeMsg",setup(e){const t=Me(""),r=Me(""),n=dr(),o=Ms();n.message||o.push({name:"home"}),Ss(()=>{window.addEventListener("keyup",s),a("click on letter within the message to select the encoded letter, then use the keyboard to determine what the real letter is")}),Un(()=>{window.removeEventListener("keyup",s)});function s(l){i(l.key)}function i(l){n.addKey(t.value,l)}function a(l,c=3e3){r.value=l,c>0&&setTimeout(()=>{r.value=""},c)}return(l,c)=>(Z(),J(ae,null,[ye(Hs,null,{default:ws(()=>[r.value?(Z(),J("div",ib,$e(r.value),1)):qf("",!0)]),_:1}),ye(Yy,{"active-letter":t.value,"onUpdate:active-letter":c[0]||(c[0]=u=>t.value=u)},null,8,["active-letter"]),ab,R("div",null,[R("h4",null,[At(" Total letters: "),R("output",null,$e(Ae(n).allLetterStats.totalLetters),1)])]),ye(xy,{onKey:i,onEnter:c[1]||(c[1]=u=>Ae(o).push({name:"decoded-key-details"})),"active-encoded-letter":t.value},null,8,["active-encoded-letter"]),ye(ob,{"active-letter":t.value,"onUpdate:active-letter":c[2]||(c[2]=u=>t.value=u)},null,8,["active-letter"])],64))}});const cb=St(lb,[["__scopeId","data-v-3efff174"]]),ou=e=>(kr("data-v-43891b7e"),e=e(),Ur(),e),ub={id:"letter-details"},fb=ou(()=>R("tr",null,[R("th",{rowspan:"2"},"Encoded"),R("th",{rowspan:"2"},"Decodes to"),R("th",{rowspan:"2"},"Occurences"),R("th",{colspan:"3"},"probabilities")],-1)),db=ou(()=>R("tr",null,[R("th",null,"Value"),R("th",null,"Rank / 26"),R("th",null,"max (all letters)")],-1)),vb=["onClick"],pb=rt({__name:"DecodedKeysFinalDetails",setup(e){const t=dr(),r=he(()=>[...t.decryptionKeys.keys()].map(n=>{const o=t.decryptionKeys.get(n),s=t.allLetterStats.letterDetails[n],i=ru(s.decodesToProbs),a=l=>l.toFixed(4);return{encoded:n,decoded:o,count:s.count,pValue:a(s.decodesToProbs[o]),rank:i.indexOf(o)+1,maxP:i[0]}}));return(n,o)=>{const s=Nf("RouterLink");return Z(),J(ae,null,[R("div",ub,[R("table",null,[R("tbody",null,[fb,db,(Z(!0),J(ae,null,Je(Ae(r),i=>(Z(),J("tr",{key:i.encoded},[R("td",null,$e(i.encoded),1),R("td",null,$e(i.decoded),1),R("td",null,$e(i.count),1),R("td",null,$e(i.pValue),1),R("td",null,$e(i.rank),1),R("td",null,$e(i.maxP),1)]))),128))])])]),ye(s,{to:"/decode",custom:""},{default:ws(({navigate:i})=>[R("button",{class:"btn",onClick:i,role:"link"},"Back to decoding",8,vb)]),_:1})],64)}}});const hb=St(pb,[["__scopeId","data-v-43891b7e"]]),gb=Vd({history:ld("/letter-swap-decoder/"),routes:[{path:"/",name:"home",component:Ly},{path:"/decode",name:"decode",component:cb},{path:"/encode",name:"encode",component:Ky},{path:"/decoded-key-details",name:"decoded-key-details",component:hb}]});const Xs=M0(Yd);Xs.use(U0());Xs.use(gb);Xs.mount("#app");
